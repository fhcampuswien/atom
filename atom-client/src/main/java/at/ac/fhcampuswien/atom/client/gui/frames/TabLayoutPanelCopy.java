 ...
 * </pre>
 */
public class TabLayoutPanelCopy extends ResizeComposite implements HasWidgets,
  ...
  private class Tab extends SimplePanel {
    ...
    public Tab(Widget child) {
      ...
      setWidget(child);
      // CHANGE1: We don't want the standard GWT styles
    ...
    public boolean remove(Widget w) {
      ...
      if (replacingWidget || index < 0) {
        ...
        return TabLayoutPanelCopy.this.remove(index);
      }
    }
  ...
  private class TabbedDeckLayoutPanel extends DeckLayoutPanel {
    ...
    public boolean remove(Widget w) {
       ...
       */
      return TabLayoutPanelCopy.this.remove(w);
    }
  ...
  // CHANGE2: We don't want the standard GWT styles
  ...
  // CHANGE3: we need access to the tabBar and the DeckPanel
  public FlowPanel getTabBar() {
	  return tabBar;
  }
  
  public TabbedDeckLayoutPanel getDeckPanel() {
	  return deckPanel;
  }
